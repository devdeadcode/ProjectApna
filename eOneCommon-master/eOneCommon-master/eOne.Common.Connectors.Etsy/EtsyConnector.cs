...
namespace eOne.Common.Connectors.Etsy
{
    public class EtsyConnector : RestConnector
    {
        ...
        private static void AddListingActions(DataConnectorEntity entity)
        {
            ...
            activateAction.AddParameter("listing_id", ConnectorActionParameter.ConnectorActionParameterType.Field, entity.FindField("listing_id"));
            activateAction.AddCondition(entity.FindField("state"), ConnectorRestriction.ConnectorRestrictionType.DoesNotEqual, "active");
            ...
            inactivateAction.AddParameter("listing_id", ConnectorActionParameter.ConnectorActionParameterType.Field, entity.FindField("listing_id"));
            activateAction.AddCondition(entity.FindField("state"), ConnectorRestriction.ConnectorRestrictionType.Equals, "active");
        }
        private static void AddListingFavorites(DataConnectorEntity entity)
        {
