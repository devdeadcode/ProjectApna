...
{
    public class EtsyListing : DataConnectorEntityModel
    {
        ...
        [FieldSettings("Listing ID", FieldTypeId = DataConnector.FieldTypeIdInteger)]
        ...
        [FieldSettings("Number of views", FieldTypeId = DataConnector.FieldTypeIdInteger)]
        public int views { get; set; }

        [FieldSettings("Number of favorites", FieldTypeId = DataConnector.FieldTypeIdInteger)]
        public int num_favorers { get; set; }

        [FieldSettings("Category path")]
        public string category_path { get; set; }

        [FieldSettings("Recipient", FieldTypeId = DataConnector.FieldTypeIdEnum, EnumType = typeof(EtsyListingRecipient))]
        public EtsyListingRecipient recipient { get; set; }

        [FieldSettings("Occasion", FieldTypeId = DataConnector.FieldTypeIdEnum, EnumType = typeof(EtsyListingOccasion))]
        public EtsyListingOccasion occasion { get; set; }

        [FieldSettings("Minimum number of days for processing", FieldTypeId = DataConnector.FieldTypeIdInteger)]
        public int processing_min { get; set; }

        [FieldSettings("Maximum number of days for processing", FieldTypeId = DataConnector.FieldTypeIdInteger)]
        public int processing_max { get; set; }

        [FieldSettings("Made by", FieldTypeId = DataConnector.FieldTypeIdEnum, EnumType = typeof(EtsyListingOccasion))]
        public EtsyListingWhoMade who_made { get; set; }

        [FieldSettings("Supply", FieldTypeId = DataConnector.FieldTypeIdYesNo)]
        public bool is_supply { get; set; }

        [FieldSettings("Item weight", FieldTypeId = DataConnector.FieldTypeIdInteger)]
        public int item_weight { get; set; }

        [FieldSettings("Item weight unit")]
        public string item_weight_units { get; set; }

        [FieldSettings("Item length", FieldTypeId = DataConnector.FieldTypeIdInteger)]
        public int item_length { get; set; }

        [FieldSettings("Item width", FieldTypeId = DataConnector.FieldTypeIdInteger)]
        public int item_width { get; set; }

        [FieldSettings("Item height", FieldTypeId = DataConnector.FieldTypeIdInteger)]
        ...
        [FieldSettings("Non-taxable", FieldTypeId = DataConnector.FieldTypeIdYesNo)]
        public bool non_taxable { get; set; }

        [FieldSettings("Customizable", FieldTypeId = DataConnector.FieldTypeIdYesNo)]
        public bool is_customizable { get; set; }

        [FieldSettings("Digital", FieldTypeId = DataConnector.FieldTypeIdYesNo)]
        public bool is_digital { get; set; }

        [FieldSettings("Digital file data")]
        public string file_data { get; set; }

        [FieldSettings("Has variations", FieldTypeId = DataConnector.FieldTypeIdYesNo)]
        public bool has_variations { get; set; }

        [FieldSettings("Automatic renewals", FieldTypeId = DataConnector.FieldTypeIdYesNo)]
        public bool should_auto_renew { get; set; }

        [FieldSettings("Language")]
        public string language { get; set; }

        [FieldSettings("Feature order", FieldTypeId = DataConnector.FieldTypeIdInteger)]
        ...
        [FieldSettings("Status", FieldTypeId = DataConnector.FieldTypeIdEnum, EnumType = typeof(EtsyListingState))]
        public EtsyListingState listing_status => (EtsyListingState)Enum.Parse(typeof(EtsyListingState), state.ToUpper());

        [FieldSettings("When made", FieldTypeId = DataConnector.FieldTypeIdEnum, EnumType = typeof(EtsyListingWhenMade))]
        public EtsyListingWhenMade listing_when_made => (EtsyListingWhenMade)Enum.Parse(typeof(EtsyListingWhenMade), $"_{when_made}");
        ...
        [FieldSettings("Ending date", FieldTypeId = DataConnector.FieldTypeIdDate)]
        public DateTime ending_date => FromEpochSeconds(ending_tsz).Date;

        [FieldSettings("Ending time", FieldTypeId = DataConnector.FieldTypeIdTime)]
        public DateTime ending_time => Time(FromEpochSeconds(ending_tsz));

        [FieldSettings("Original creation date", FieldTypeId = DataConnector.FieldTypeIdDate)]
        public DateTime original_creation_date => FromEpochSeconds(original_creation_tsz).Date;

        [FieldSettings("Original creation time", FieldTypeId = DataConnector.FieldTypeIdTime)]
        public DateTime original_creation_time => Time(FromEpochSeconds(original_creation_tsz));

        [FieldSettings("Last modified date", FieldTypeId = DataConnector.FieldTypeIdDate, Modified = true)]
        public DateTime last_modified_date => FromEpochSeconds(last_modified_tsz).Date;

        [FieldSettings("Last modified time", FieldTypeId = DataConnector.FieldTypeIdTime, Modified = true)]
        public DateTime last_modified_time => Time(FromEpochSeconds(last_modified_tsz));

        [FieldSettings("Last state change date", FieldTypeId = DataConnector.FieldTypeIdDate)]
        public DateTime state_date => FromEpochSeconds(state_tsz).Date;

        [FieldSettings("Last state change time", FieldTypeId = DataConnector.FieldTypeIdTime)]
        public DateTime state_time => Time(FromEpochSeconds(state_tsz));
        ...
        [FieldSettings("Featured", FieldTypeId = DataConnector.FieldTypeIdYesNo)]
