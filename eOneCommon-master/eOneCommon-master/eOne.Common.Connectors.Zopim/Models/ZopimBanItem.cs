...
{
    public class ZopimBanItem : DataConnectorEntityModel
    {
        ...
        [FieldSettings("Type", DefaultField = true, FieldTypeId = DataConnector.FieldTypeIdEnum, EnumType = typeof(ZopimBanItemType))]
