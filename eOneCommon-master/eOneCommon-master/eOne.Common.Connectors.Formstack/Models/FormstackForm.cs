...
{
    public class FormstackForm : DataConnectorEntityModel
    {
        ...
        public DateTime updated_date => updated.Date;

        public DateTime updated_time => Time(updated);
        public DateTime last_submission_date => last_submission_time.Date;
        public DateTime last_submission_time_time => Time(last_submission_time);
    }
}