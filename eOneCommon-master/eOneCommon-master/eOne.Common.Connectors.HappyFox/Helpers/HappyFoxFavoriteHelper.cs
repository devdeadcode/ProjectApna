...
namespace eOne.Common.Connectors.HappyFox.Models
{
    public class HappyFoxFavoriteHelper
    {
        ...
        public static void UpdateFavorites(DataConnectorEntity entity)
        {
            ...
            statusChangeFavorite.Query.AddFields("ticket_subject", "update_date", "from_category", "to_category");
            statusChangeFavorite.Query.AddRestriction("update_type", ConnectorRestriction.ConnectorRestrictionType.Equals, "category_change");
            ...
            statusChangeFavorite.Query.AddRestriction("update_type", ConnectorRestriction.ConnectorRestrictionType.Equals, "priority_change");

            // add user assignments
            var userAssignments = entity.AddFavorite("User assignments");
            priorityChangesFavorite.Query.AddFields("ticket_subject", "update_date", "assigned_from", "assigned_to");
            statusChangeFavorite.Query.AddRestriction("update_type", ConnectorRestriction.ConnectorRestrictionType.Equals, "assign_user");
