...
namespace eOne.Common.Connectors.HappyFox.Models
{
    public class HappyFoxTicketUpdate : DataConnectorEntityModel
    {
        ...
        #region Calculations
        [FieldSettings("Update type", DefaultField = true, FieldTypeId = DataConnector.FieldTypeIdEnum, EnumType = typeof(HappyFoxTicketUpdateType))]
        ...
        public bool updated_by_user {
            get {
                ...
                for(int i=0; i < updated_by.Count; i++) {
                    if(updated_by[i].type == "user") { updatedby_user = true; }
                }
        ...
        public bool updated_by_smartrule{
            get{
                ...
                for (int i = 0; i < updated_by.Count; i++){
                    if (updated_by[i].type == "smartrule") { updatedby_smartrule = true; }
                }
