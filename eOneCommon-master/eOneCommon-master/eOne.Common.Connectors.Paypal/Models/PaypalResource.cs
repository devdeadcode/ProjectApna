...
{
    public class PaypalResource : DataConnectorEntityModel
    {
        ...
        public DateTime create_time
        {
            get
            {
                ...
                {
                    case PaypalResourceType.sale:
                        return Time(sale.create_time);
                    case PaypalResourceType.refund:
                        return Time(refund.create_time);
                    case PaypalResourceType.capture:
                        return Time(capture.create_time);
                    case PaypalResourceType.authorization:
                        return Time(authorization.create_time);
                }
        ...
        public DateTime create_date
        {
            get
            {
                ...
                {
                    case PaypalResourceType.sale:
                        return sale.create_time.Date;
                    case PaypalResourceType.refund:
                        return refund.create_time.Date;
                    case PaypalResourceType.capture:
                        return capture.create_time.Date;
                    case PaypalResourceType.authorization:
                        return authorization.create_time.Date;
                }
                return DateTime.MinValue;
            }
        }
        public DateTime update_time
        {
            get
            {
                ...
                {
                    case PaypalResourceType.sale:
                        return Time(sale.update_time);
                    case PaypalResourceType.refund:
                        return Time(refund.update_time);
                    case PaypalResourceType.capture:
                        return Time(capture.update_time);
                    case PaypalResourceType.authorization:
                        return Time(authorization.update_time);
                }
                return DateTime.MinValue;
            }
        }
        public DateTime update_date
        {
            get
            {
                ...
                {
                    case PaypalResourceType.sale:
                        return sale.update_time.Date;
                    case PaypalResourceType.refund:
                        return refund.update_time.Date;
                    case PaypalResourceType.capture:
                        return capture.update_time.Date;
                    case PaypalResourceType.authorization:
                        return authorization.update_time.Date;
                }
                return DateTime.MinValue;
            }
        }
