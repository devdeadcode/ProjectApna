...
{
    public class PaypalInvoice : DataConnectorEntityModel
    {
        ...
        [FieldSettings("Status", DefaultField = true, FieldTypeId = DataConnector.FieldTypeIdEnum, EnumType = typeof(PaypalInvoiceStatus))]
        ...
        [FieldSettings("Created date", Created = true, FieldTypeId = DataConnector.FieldTypeIdDate)]
        public DateTime metadata_created_date => metadata == null ? DateTime.MinValue.Date : DateFromString(metadata.created_date);
        ...
        public DateTime metadata_cancelled_date => metadata == null ? DateTime.MinValue.Date : DateFromString(metadata.cancelled_date);
        ...
        public DateTime metadata_last_updated_date => metadata == null ? DateTime.MinValue.Date : DateFromString(metadata.last_updated_date);
        ...
        public DateTime metadata_first_sent_date => metadata == null ? DateTime.MinValue.Date : DateFromString(metadata.first_sent_date);

        [FieldSettings("Last sent date", FieldTypeId = DataConnector.FieldTypeIdDate)]
        public DateTime metadata_last_sent_date => metadata == null ? DateTime.MinValue.Date : DateFromString(metadata.last_sent_date);
        ...
        public DateTime refund_date
        {
            get
            {
                if (refunds == null || refunds.Count == 0) return DateTime.MinValue.Date;
        ...
        public DateTime payment_date
        {
            get
            {
                if (payments == null || payments.Count == 0) return DateTime.MinValue.Date;
        ...
        [FieldSettings("Merchant first name", FieldTypeId = DataConnector.FieldTypeIdEmail)]
        public string merchant_info_first_name => merchant_info == null ? string.Empty : merchant_info.first_name;

        [FieldSettings("Merchant last name", FieldTypeId = DataConnector.FieldTypeIdEmail)]
        public string merchant_info_last_name => merchant_info == null ? string.Empty : merchant_info.last_name;

        [FieldSettings("Merchant name", FieldTypeId = DataConnector.FieldTypeIdEmail)]
