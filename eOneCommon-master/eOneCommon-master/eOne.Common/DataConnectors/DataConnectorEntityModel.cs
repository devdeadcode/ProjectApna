...
{
    public class DataConnectorEntityModel
    {
        ...
        // date methods
        public DateTime Time(DateTime value)
        {
            return default(DateTime).Add(value.TimeOfDay);
        }
        public DateTime DateFromString(string value)
        {
            return string.IsNullOrWhiteSpace(value) ? DateTime.MinValue.Date : DateTime.Parse(value).Date;
        }
        ...
        // todo - add length conversion methods
