...
namespace eOne.Common.Connectors.Xero.Models
{
    public class XeroAccount
    {
        ...
        [FieldSettings("Class", DefaultField = true, FieldTypeId = DataConnector.FieldTypeIdEnum, EnumType = typeof(XeroAccountClass))]
        public XeroAccountClass Class { get; set; }

        [FieldSettings("Type", DefaultField = true, FieldTypeId = DataConnector.FieldTypeIdEnum, EnumType = typeof(XeroAccountType))]
        ...
        [FieldSettings("Tax type", FieldTypeId = DataConnector.FieldTypeIdEnum, EnumType = typeof(XeroAccountTaxType))]
        public XeroAccountTaxType TaxType { get; set; }

        [FieldSettings("Enable payments to account", FieldTypeId = DataConnector.FieldTypeIdYesNo)]
        ...
        [FieldSettings("Status", FieldTypeId = DataConnector.FieldTypeIdEnum, EnumType = typeof(XeroAccountStatus))]
        public XeroAccountStatus Status { get; set; }

        [FieldSettings("System account", FieldTypeId = DataConnector.FieldTypeIdEnum, EnumType = typeof(XeroAccountSystemAccountType))]
