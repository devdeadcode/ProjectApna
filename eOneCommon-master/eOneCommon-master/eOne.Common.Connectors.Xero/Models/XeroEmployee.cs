...
{
    public class XeroEmployee : DataConnectorEntityModel
    {
        ...
        [FieldSettings("Status", DefaultField = true, FieldTypeId = DataConnector.FieldTypeIdEnum, EnumType = typeof(XeroEmployeeStatus))]
