...
namespace eOne.Common.Connectors.Xero.Models
{
    public class XeroContactGroup
    {
        ...
        [FieldSettings("Number of contacts", DefaultField = true, FieldTypeId = DataConnector.FieldTypeIdInteger)]
        ...
        [FieldSettings("Status", FieldTypeId = DataConnector.FieldTypeIdEnum, EnumType = typeof(XeroContactGroupStatus))]
