...
{
    public class ShopifyOrderLines : ConnectorEntityModel
    {
        ...
        [FieldSettings("Buyer accepts marketing", FieldTypeId = Connector.FieldTypeIdYesNo)]
        ...
        [FieldSettings("Cancel reason", FieldTypeId = Connector.FieldTypeIdEnum, EnumType = typeof(ShopifyOrder.ShopifyOrderCancelReason))]
        ...
        [FieldSettings("Financial status", FieldTypeId = Connector.FieldTypeIdEnum, EnumType = typeof(ShopifyOrder.ShopifyOrderFinancialStatus))]
        ...
        [FieldSettings("Order fulfillment status", FieldTypeId = Connector.FieldTypeIdEnum, EnumType = typeof(ShopifyOrder.ShopifyOrderFulfillmentStatus))]
        ...
        [FieldSettings("Processing method", FieldTypeId = Connector.FieldTypeIdEnum, EnumType = typeof(ShopifyOrder.ShopifyOrderProcessingMethod))]
        ...
        [FieldSettings("Taxes included", FieldTypeId = Connector.FieldTypeIdYesNo)]
        public bool OrderTaxesIncluded => Order.taxes_included;

        [FieldSettings("Token")]
        public string OrderToken => Order.token;

        [FieldSettings("Cancelled at date", FieldTypeId = Connector.FieldTypeIdDate)]
        public DateTime? OrderCancelledAtDate => Order.cancelled_at;

        [FieldSettings("Closed at date", FieldTypeId = Connector.FieldTypeIdDate)]
        public DateTime? OrderClosedAtDate => Order.closed_at;

        [FieldSettings("Created at date", Created = true, FieldTypeId = Connector.FieldTypeIdDate)]
        public DateTime? OrderCreatedAtDate => Order.created_at;

        [FieldSettings("Processed at date", FieldTypeId = Connector.FieldTypeIdDate)]
        public DateTime? OrderProcessedAtDate => Order.processed_at;

        [FieldSettings("Updated at date", Modified = true, FieldTypeId = Connector.FieldTypeIdDate)]
        public DateTime? OrderUpdatedAtDate => Order.updated_at;
        ...
        [FieldSettings("Billing address phone number", FieldTypeId = Connector.FieldTypeIdPhone)]
        ...
        [FieldSettings("Shipping address phone number", FieldTypeId = Connector.FieldTypeIdPhone)]
        ...
        [FieldSettings("Number of orders from customer", FieldTypeId = Connector.FieldTypeIdInteger)]
        public int OrderCustomerOrdersCount => Order.customer_orders_count ?? 0;

        [FieldSettings("Customer status", FieldTypeId = Connector.FieldTypeIdEnum, EnumType = typeof(ShopifyCustomer.ShopifyCustomerState))]
        ...
        [FieldSettings("Total spent by customer", FieldTypeId = Connector.FieldTypeIdCurrency)]
        ...
        [FieldSettings("Fulfillable quantity", FieldTypeId = Connector.FieldTypeIdInteger)]
        ...
        [FieldSettings("Line fulfillment status")]
        public string LineFulfillmentStatus => Line.fulfillment_status;

        [FieldSettings("Weight in grams", FieldTypeId = Connector.FieldTypeIdInteger)]
        public int LineGrams => Line.grams;

        [FieldSettings("Requires shipping", FieldTypeId = Connector.FieldTypeIdYesNo)]
        ...
        [FieldSettings("Gift card", FieldTypeId = Connector.FieldTypeIdYesNo)]
        ...
        [FieldSettings("Unit price", FieldTypeId = Connector.FieldTypeIdCurrency)]
