...
{
    public class ShopifyOrder : ConnectorEntityModel
    {
        ...
        [FieldSettings("Cancel reason", FieldTypeId = Connector.FieldTypeIdEnum, EnumType = typeof(ShopifyOrderCancelReason))]
        public ShopifyOrderCancelReason? cancel_reason { get; set; }

        [FieldSettings("Financial status", FieldTypeId = Connector.FieldTypeIdEnum, EnumType = typeof(ShopifyOrderFinancialStatus))]
        public ShopifyOrderFinancialStatus? financial_status { get; set; }

        [FieldSettings("Fulfillment status", FieldTypeId = Connector.FieldTypeIdEnum, EnumType = typeof(ShopifyOrderFulfillmentStatus))]
        public ShopifyOrderFulfillmentStatus? fulfillment_status { get; set; }

        [FieldSettings("Processing method", FieldTypeId = Connector.FieldTypeIdEnum, EnumType = typeof(ShopifyOrderProcessingMethod))]
        ...
        [FieldSettings("Number", FieldTypeId = Connector.FieldTypeIdInteger)]
        ...
        [FieldSettings("Total discounts", FieldTypeId = Connector.FieldTypeIdCurrency)]
        public decimal? total_discounts { get; set; }

        [FieldSettings("Total line items price", FieldTypeId = Connector.FieldTypeIdCurrency)]
        ...
        [FieldSettings("Cancelled", FieldTypeId = Connector.FieldTypeIdYesNo)]
        ...
        [FieldSettings("Total weight in kilograms", FieldTypeId = Connector.FieldTypeIdQuantity)]
        ...
        [FieldSettings("Total weight in pounds", FieldTypeId = Connector.FieldTypeIdQuantity)]
