...
{
    public class TimelyEvent : ConnectorEntityModel
    {
        ...
        [FieldSettings("Cost", DefaultField = true, FieldTypeId = Connector.FieldTypeIdQuantity)]
        ...
        [FieldSettings("Estimated cost", FieldTypeId = Connector.FieldTypeIdQuantity)]
        public decimal estimated_cost { get; set; }

        [FieldSettings("Number of days", FieldTypeId = Connector.FieldTypeIdQuantity)]
        ...
        [FieldSettings("Estimated", FieldTypeId = Connector.FieldTypeIdYesNo)]
        public bool estimated { get; set; }

        [FieldSettings("Timer started on", FieldTypeId = Connector.FieldTypeIdQuantity)]
        public decimal timer_started_on { get; set; }

        [FieldSettings("Timer stopped on", FieldTypeId = Connector.FieldTypeIdQuantity)]
        public decimal timer_stopped_on { get; set; }

        [FieldSettings("Created from")]
        public string created_from { get; set; }

        [FieldSettings("Updated from")]
        public string updated_from { get; set; }

        [FieldSettings("Sequence", FieldTypeId = Connector.FieldTypeIdInteger)]
        public int sequence { get; set; }

        [FieldSettings("Event ID", KeyNumber = 1, FieldTypeId = Connector.FieldTypeIdInteger)]
