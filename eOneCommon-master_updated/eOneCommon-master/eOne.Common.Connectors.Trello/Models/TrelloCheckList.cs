...
{
    public class TrelloCheckList : ConnectorEntityModel
    {
        ...
        public DateTime? cardDue => card.due;

        [FieldSettings("Card email")]
        public string cardEmail => card.email;

        [FieldSettings("Card short Url", FieldTypeId = Connector.FieldTypeIdUrl)]
        public string cardShortUrl => card.shortUrl;

        [FieldSettings("Card Url", FieldTypeId = Connector.FieldTypeIdUrl)]
        ...
        [FieldSettings("Number of check items", FieldTypeId = Connector.FieldTypeIdInteger)]
        public int NumberOfCheckItems => checkItems.Count;

        [FieldSettings("Number of completed check items", FieldTypeId = Connector.FieldTypeIdInteger)]
        ...
        [FieldSettings("Number of incomplete check items", FieldTypeId = Connector.FieldTypeIdInteger)]
