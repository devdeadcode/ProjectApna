...
namespace eOne.Common.Connectors.Xero.Models
{
    public class XeroInvoiceLineItem
    {
        ...
        [FieldSettings("Invoice type", DefaultField = true, FieldTypeId = Connector.FieldTypeIdEnum, EnumType = typeof(XeroInvoice.XeroInvoiceType))]
        ...
        [FieldSettings("Tax amount", FieldTypeId = Connector.FieldTypeIdCurrency)]
        ...
        [FieldSettings("Item purchase unit price", FieldTypeId = Connector.FieldTypeIdCurrency)]
        ...
        [FieldSettings("Item sales unit price", FieldTypeId = Connector.FieldTypeIdCurrency)]
        ...
        [FieldSettings("Invoice date", FieldTypeId = Connector.FieldTypeIdDate)]
        public DateTime InvoiceDate => Invoice.Date;

        [FieldSettings("Invoice status", FieldTypeId = Connector.FieldTypeIdEnum, EnumType = typeof(XeroInvoice.XeroInvoiceType))]
        ...
        [FieldSettings("Amount type", FieldTypeId = Connector.FieldTypeIdEnum)]
        ...
        [FieldSettings("Invoice link", FieldTypeId = Connector.FieldTypeIdUrl)]
        ...
        [FieldSettings("Invoice has attachments", FieldTypeId = Connector.FieldTypeIdYesNo)]
        public bool InvoiceHasAttachments => Invoice.HasAttachments;

        [FieldSettings("Updated date", FieldTypeId = Connector.FieldTypeIdDate)]
        public DateTime InvoiceUpdatedDate => Invoice.UpdatedDateUTC;
