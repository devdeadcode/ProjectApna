...
{
    public class XeroJournalLine : ConnectorEntityModel
    {
        ...
        [FieldSettings("Account type", DefaultField = true, FieldTypeId = Connector.FieldTypeIdEnum, EnumType = typeof(XeroAccount.XeroAccountType))]
        public XeroAccount.XeroAccountType AccountType { get; set; }

        [FieldSettings("Net amount", DefaultField = true, FieldTypeId = Connector.FieldTypeIdCurrency)]
        public decimal NetAmount { get; set; }

        [FieldSettings("Tax amount", DefaultField = true, FieldTypeId = Connector.FieldTypeIdCurrency)]
        public decimal TaxAmount { get; set; }

        [FieldSettings("Gross amount", DefaultField = true, FieldTypeId = Connector.FieldTypeIdCurrency)]
