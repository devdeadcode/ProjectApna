...
{
    public class XeroContact : ConnectorEntityModel
    {
        ...
        [FieldSettings("Supplier", DefaultField = true, FieldTypeId = Connector.FieldTypeIdYesNo)]
        public bool IsSupplier { get; set; }

        [FieldSettings("Customer", DefaultField = true, FieldTypeId = Connector.FieldTypeIdYesNo)]
        public bool IsCustomer { get; set; }

        [FieldSettings("Status", DefaultField = true, FieldTypeId = Connector.FieldTypeIdEnum, EnumType = typeof(XeroContactStatus))]
