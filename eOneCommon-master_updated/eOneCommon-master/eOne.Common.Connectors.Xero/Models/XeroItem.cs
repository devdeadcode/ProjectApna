...
{
    public class XeroItem : ConnectorEntityModel
    {
        ...
        [FieldSettings("Purchase unit price", FieldTypeId = Connector.FieldTypeIdCurrency)]
        ...
        [FieldSettings("Sales unit price", FieldTypeId = Connector.FieldTypeIdCurrency)]
