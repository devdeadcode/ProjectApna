...
{
    public class SalesForceUser : ConnectorEntityModel
    {
        ...
        [FieldSettings("Digest frequency", DefaultField = true, FieldTypeId = Connector.FieldTypeIdEnum, EnumType = typeof(SalesForceUserDigestFrequency))]
