...
{
    public class PaypalInvoiceItem : ConnectorEntityModel
    {
        ...
        [FieldSettings("Extended price", DefaultField = true, FieldTypeId = Connector.FieldTypeIdCurrency)]
        ...
        [FieldSettings("Status", FieldTypeId = Connector.FieldTypeIdEnum, EnumType = typeof(PaypalInvoice.PaypalInvoiceStatus))]
        ...
        [FieldSettings("Extended price excluding tax", FieldTypeId = Connector.FieldTypeIdCurrency)]
        ...
        [FieldSettings("Invoice URL", FieldTypeId = Connector.FieldTypeIdUrl)]
        ...
        [FieldSettings("Billing language", FieldTypeId = Connector.FieldTypeIdEnum, EnumType = typeof(PaypalBillingInfo.PaypalBillingInfoLanguage))]
