...
{
    public class PaypalPayment : ConnectorEntityModel
    {
        ...
        [FieldSettings("Status", DefaultField = true, FieldTypeId = Connector.FieldTypeIdEnum, EnumType = typeof(PaypalPaymentState))]
        public PaypalPaymentState state { get; set; }

        [FieldSettings("Payment intent", DefaultField = true, FieldTypeId = Connector.FieldTypeIdEnum, EnumType = typeof(PaypalPaymentIntent))]
        public PaypalPaymentIntent intent { get; set; }

        [FieldSettings("Total transaction amount", DefaultField = true, FieldTypeId = Connector.FieldTypeIdCurrency)]
        ...
        [FieldSettings("Number of transactions", FieldTypeId = Connector.FieldTypeIdInteger)]
        ...
        [FieldSettings("Payment method", FieldTypeId = Connector.FieldTypeIdEmail)]
        public PaypalPayer.PaypalPayerPaymentMethod payer_payment_method => payer.payment_method;

        [FieldSettings("Payer status", FieldTypeId = Connector.FieldTypeIdEnum, EnumType = typeof(PaypalPayer.PaypalPayerStatus))]
        public PaypalPayer.PaypalPayerStatus payer_status => payer.status;

        [FieldSettings("Payer email", FieldTypeId = Connector.FieldTypeIdEmail)]
        ...
        [FieldSettings("Shipping address type", FieldTypeId = Connector.FieldTypeIdEnum, EnumType = typeof(PaypalShippingAddress.PaypalAddressType))]
        ...
        [FieldSettings("Payer phone number", FieldTypeId = Connector.FieldTypeIdPhone)]
        ...
        [FieldSettings("Payer tax ID type", FieldTypeId = Connector.FieldTypeIdEnum, EnumType = typeof(PaypalPayerInfo.PaypalPayerInfoTaxType))]
