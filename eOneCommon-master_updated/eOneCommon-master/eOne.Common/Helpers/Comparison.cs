...
namespace eOne.Common.Helpers
{
    public class Comparison
    {
        ...
        {
            if (records == null || type == null) return null;
            if (compareRecords == null || compareType == null) return records;
        ...
        {
            if (records == null || type == null || compareRecords == null || compareType == null) return null;
            if (fields.Count <= 0) return records;
            var comparison = records;
            foreach (var fieldPair in fields)
            {
